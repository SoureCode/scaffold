...
#[AsCommand(name: 'features:enable', description: 'Enable a feature flag (creates the row if missing).')]
final class FeatureFlagsEnableCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        (new SymfonyStyle($input, $output))->success(\sprintf('Feature flag "%s" enabled.', $name));
